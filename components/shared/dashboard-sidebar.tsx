...
export function DashboardSidebar({ role = "CUSTOMER" }: { role?: string }) {
  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed left-4 top-4 z-50 flex size-10 items-center justify-center rounded-lg border border-border bg-card shadow-sm lg:hidden"
